  ...
  <div class="child-main">
    ...
    <div class="container">
      ...
      >
          ...
          >
            ...
            <div slot="file" slot-scope="{ file }">
              <img
                ...
                :src="httpUrls.ossUrl + ruleForm.fileList[0].file_url"
                alt=""
              />
        ...
        <el-form-item>
          <div class="submit-btn" @click="submitForm('ruleForm')">保存</div>
        </el-form-item>
      </el-form>
    </div>
  </div>
