  ...
  <div style="width: 100%; height: 100%; background-color: #f1f2f5">
        ...
        <div class="uploadImg" v-if="!chatList.length">
          ...
          >
            ...
            <template v-if="!oldchatImageFile">
              ...
              <div class="el-upload__text" style="margin-top: 5px">图片大小不超过2Mb</div>
            </template>
            <template v-else>
              ...
              <div style="position: relative; width: 180px; height: 180px; margin: auto">
                ...
                <img
                  ...
                  :src="httpUrls.ossUrl + oldchatImageFile"
                  alt=""
                />
              </div>
            </template>
    ...
    <div class="footer_cont">
      <div class="btn_cont">
        ...
        <div style="font-size: 13px; color: #999">810算力/1k token</div>
      </div>
      <div class="cont">
        <div
          :class="
    ...
    <el-dialog :visible.sync="supplyVisible" width="500px">
      ...
      <span slot="footer" class="chat-dialog-footer" @click="keepAs(2)"> 发送 </span>
    </el-dialog>
...
import { creatChat, chatDetail, creatDraw, questionSetRecommend } from "../../api/chatMG";
      ...
      if (!this.isfinishThreeFive) {
        ...
        if (res != "" && res.content != null) {
          ...
          if (res.finish_reason != "stop") {
            ...
            this.chatList[this.chatList.length - 1].content = this.chatList[
