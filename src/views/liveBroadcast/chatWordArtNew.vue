  ...
  <div class="draw-chat">
    <div class="work_area" style="width: 390px">
      <div class="select_workspace">
        <div class="item" @click="showWorspaceOrHistory(1)">艺术字姓氏头像九宫格</div>
      </div>
    ...
    <div class="main">
    <img  class="bgImg" :src='httpUrls.ossUrl+"static/picture/ae428219-38b5-4e52-82cb-17c21a864983.png"' alt="">
