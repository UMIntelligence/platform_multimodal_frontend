    ...
    <div class="container">
      <div class="video-box">
        ...
        <div class="waiting" v-else-if="isTimestableDiffusion">
          ...
          <div class="progress">
            <el-progress :stroke-width="10" :show-text="false" :percentage="percentageNumber"></el-progress>
          </div>
...
export default {
  ...
  methods: {
    ...
    // 获取示例
    getRecommend(){
      get_Audio_Video_recommend(13).then(res => {
        console.log(res)
        if(res.code == 20000){
      ...
      .waiting{
        ...
        .progress{
          ...
          /deep/ .el-progress-bar__inner{
            background: linear-gradient( 270deg, #D86BFF 0%, #2467FF 51%, #03C3FF 100%);
          }
        }
        .text{
          font-weight: 400;
